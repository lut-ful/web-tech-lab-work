        ...
        <fieldset>
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <input type="text" id="full_name" name="full_name" value="<?= retainValue('full_name', $values) ?>">
                ...
                <tr>
                    ...
                    <td>
                        <select id="skills" name="skills[]" multiple>
                            ...
                            <option value="web_dev" <?= retainSelected('skills', 'web_dev', $values) ?>>Web Development</option>
                            <option value="graphic_design" <?= retainSelected('skills', 'graphic_design', $values) ?>>Graphic Design</option>
                            <option value="content_writing" <?= retainSelected('skills', 'content_writing', $values) ?>>Content Writing</option>
                ...
                <tr>
                    ...
                    <td>
                        <input type="number" id="hours" name="hours" min="1" max="168" value="<?= retainValue('hours', $values) ?>">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="radio" id="bank_transfer" name="payment" value="bank_transfer" <?= retainChecked('payment', 'bank_transfer', $values) ?>> <label for="bank_transfer">Bank Transfer</label>
                ...
                <tr>
                    ...
                    <td>
                        <textarea id="about_you" name="about_you" rows="4" cols="30"><?= retainValue('about_you', $values) ?></textarea>
